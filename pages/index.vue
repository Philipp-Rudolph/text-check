<template>
  ...
  <div
    class="max-w-7xl mx-auto p-6 md:p-8 bg-[#1a1d2d] rounded-2xl shadow-lg text-white font-mono flex flex-col items-center">
      ...
      <div v-if="comparisonDone && (firstString || secondString)" class="w-full">
        ...
        <Transition name="fade" mode="out-in">
          <div v-if="isExactMatch" class="flex flex-col items-center justify-center md:justify-start gap-2">
            ...
            <div
              class="bg-[#2a2d3b] p-4 md:p-6 rounded-lg overflow-x-auto max-h-[300px] w-full whitespace-pre-wrap break-words text-sm md:text-lg flex flex-col gap-2">
              {{ firstString }}
